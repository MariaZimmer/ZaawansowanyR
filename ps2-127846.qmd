...
```
:::
W analizie zastosowano odsetki kolumnowe, ponieważ pokazuje on odsetki w podzialne na pracę na czarno/szaro
...
- Płeć vs `n1`: V Craméra = *0.075*, p = *0.00018683*
- Grupa wieku vs `n1`: V Craméra = *0.197*, p = *9.992e-16*
- Wykształcenie vs `n1`: V Craméra = *0.121*, p = *2.4005e-06*
- Status BAEL vs `n1`: V Craméra = *0.093*, p = *5.6743e-04*

Która zmienna grupująca jest **najsilniej** powiązana z pracą nierejestrowaną? *wiek*
VCramera = 0.197
...
| Metoda | $\hat{\mu}_{n1}$ |
|---|---:|
| BKL bez wag | *0.04240983* |
| Kalibracja IPW do statusu BAEL | *0.03956906* |
| Kalibracja IPW do wieku + statusu + płci | *0.04070381* |
...
Kalibracja i po statusie i po wieku daje podobne wyniki, jednakże status jest lepszy. 
